...
### Werte, Prinzipien und Normen als Begriffsleiter
...
::: {.widget}
<iframe id="heider-simmel-embed" width="100%" height="420px" frameborder="0" title="Heider-Simmel-Experiment" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<script>document.getElementById("heider-simmel-embed").src = "https://www.youtube.com/embed/VTNmLt7QX8E";</script>
:::
...
### Warum KI Verantwortung (noch) nicht trägt
...
![Werte, Normen und Funktionalitäten bauen aufeinander auf: Normen entstehen aus der Interpretation von Werten, Funktionalitäten aus der Konkretisierung von Normen (eigene Darstellung in Anlehnung an Dignum 2019: S. 63).](media/dignum-werte-normen-funktionen.png)

Das Systemdesign wird über drei Verbindungsebenen an diese Kette angeschlossen (Dignum 2019, S. 65): *intention* verknüpft die zugrunde liegenden Werte mit der Zwecksetzung des Systems, *boundary* übersetzt Normen in Grenzen und Rahmenbedingungen des zulässigen Systemverhaltens, und *instantiation* setzt die daraus abgeleiteten Funktionalitäten im technischen Design um.
...
![Die zirkuläre Prozessstruktur: Die fünf Schritte bilden keinen linearen Ablauf, sondern einen fortlaufenden Kreislauf, der das System an sich wandelnde Werte und Wahrnehmungen anpasst (eigene Darstellung in Anlehnung an Dignum 2019).](media/dignum-prozess-zyklus.png)
