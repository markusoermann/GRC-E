...
- **Quelle:** Neuaufsetzung der Bestandspräsentation `251124_GRC&E.pptx` (206 Folien) unter Beibehaltung von Gliederung und Struktur

## Terminologie-Konventionen (kursweit)

- **DSGVO** (nicht „DS-GVO"), **BSIG**, **KI-VO** (synonym EU AI Act), **KRITIS-Dachgesetz** (KRITIS-DachG)
- **pbD** = personenbezogene Daten · **TOMs** = technische und organisatorische Maßnahmen
- **Verantwortlicher** (Art. 4 Nr. 7 DSGVO), **Auftragsverarbeiter** (Art. 4 Nr. 8), **Anbieter**/**Betreiber** (KI-VO)
- Normzitate im Fließtext mit verlinkter Fundstelle (eur-lex / gesetze-im-internet)
...
Genutzte Wiki-Knoten: [[DSGVO Art. 4]], [[DSGVO Art. 5]], [[DSGVO Art. 6]], [[DSGVO Art. 9]], [[DSGVO Art. 22]], [[DSGVO Art. 25]], [[EU AI Act Art. 5]], [[EU AI Act Art. 6]], [[EU AI Act Art. 50]], [[KRITIS-Regulierung]], [[BSI Grundschutz++]], [[BVerfGE 65,1 (Volkszählungsurteil)]], [[Maschinenethik]], [[Responsible AI]], [[KI-Ethikprinzipien]], [[Verantwortung (KI)]], [[Hochrisiko-KI]].
